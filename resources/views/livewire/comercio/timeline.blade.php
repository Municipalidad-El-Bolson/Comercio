<div>
  ...
  <div class="{{ $colapsado ? 'd-none' : '' }}">
    <div class="card-body pb-3">
      ...
      <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
        <select class="form-control form-control-sm mr-2" style="max-width:220px"
                wire:model="etapaActual">
        ...
        @foreach($etapas as $key => $label)
          @php
            ...
            $fechaEtapa = $mov?->fecha
              ...
              : ($key === 'comercio_inicio' && $createdAt ? \Illuminate\Support\Carbon::parse($createdAt)->format('d-m-Y') : null);
  ...
  <style>
    .timeline-wrap{
      position:relative;
      display:flex;
      align-items:flex-start; /* etiquetas debajo */
    ...
    .timeline-wrap .step:not(.last)::after{
      content:"";
      position:absolute;
      top: 18px;              /* centro vertical del dot (36px/2) */
      left: calc(50% + 18px); /* mitad + radio del dot para que arranque desde el borde derecho del círculo */
      right: -50%;
      height:2px;
      background:#e2e3e5;
      transform: translateY(-50%); /* centra exacto en el centro del dot */
      z-index: 0;
    }
    ...
    .timeline-wrap .dot{
      ...
      background:#f8f9fa; border:2px solid #ced4da; color:#6c757d;
      margin: 0 auto; position:relative; z-index:2;
    }
    .timeline-wrap .step.done .dot{
      background:#e9f7ec; border-color:#28a745; color:#28a745;
    }

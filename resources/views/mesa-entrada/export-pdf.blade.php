...
<html lang="es"><head><meta charset="utf-8"><style>
  ...
  .fecha{width:7%}.numero{width:8%}.titular{width:16%}.hc{width:7%}.docs{width:24%}.obs{width:17%}.usuario{width:10%}.carga{width:11%}
  ...
  <table><thead><tr><th class="fecha">Fecha</th><th class="numero">Nº de expediente</th><th class="titular">Titular / Razón social</th><th class="hc">HC</th><th class="docs">Documentación</th><th class="obs">Observación</th><th class="usuario">Ingresó</th><th class="carga">Fecha de carga</th></tr></thead>
  <tbody>@forelse($rows as $row)<tr>@foreach($row as $value)<td>{{ $value ?: '—' }}</td>@endforeach</tr>@empty<tr><td colspan="8">No se encontraron registros para los filtros aplicados.</td></tr>@endforelse</tbody></table>

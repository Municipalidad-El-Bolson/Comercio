...
class DocumentoSeeder extends Seeder
{
    public function run(): void
    {
        $nombres = [
            ...
            'Nota de Solicitud de Cambio de domicilio',
            'Nota de Solicitud de Cambio de Nombre de fantasía',
            'Nota de Solicitud de Cambio de rubro',
            'Nota de Solicitud de Cambio de baja de rubro',

    ...
    private function docKeysForEstado(string $estadoBase, bool $esJuridica): array
    {
        ...
        return match ($estadoBase) {
            ...
            '032','irregular' => [
                ...
                'doc_final_obra','doc_solicitud_cambio_domicilio','doc_solicitud_cambio_nombre_fantasia',
                'doc_solicitud_cambio_rubro','doc_solicitud_cambio_baja_rubro','doc_nota_baja_comercial',
            ],
